...
@org.pentaho.di.core.annotations.Job(
		...
		tooltip="kJube.Plugins.KjubeBatchId.Description"
	)
public class KjubeBatchId extends JobEntryBase implements Cloneable, JobEntryInterface
{
	...
	public KjubeBatchId(JobEntryBase jeb)
	{
		super(jeb);
	}
	...
	public static OperationType findOperationTypeByDescription(String description) {
	  ...
	  public void loadRep(Repository rep, long id_jobentry, List<DatabaseMeta> databases, List<SlaveServer> slaveServers) throws KettleException
	  {
	    try
	    {
	        ...
	        batchIdConnection = DatabaseMeta.findDatabase(databases, rep.getJobEntryAttributeInteger(id_jobentry, "batch_id_connection_id"));
	        batchIdConnectionName = rep.getJobEntryAttributeString(id_jobentry, "batch_id_connection_name");
	        batchIdSchema     = rep.getJobEntryAttributeString(id_jobentry, "batch_id_schema");
	        batchIdTable      = rep.getJobEntryAttributeString(id_jobentry, "batch_id_table");

	        batchLoggingConnection = DatabaseMeta.findDatabase(databases, rep.getJobEntryAttributeInteger(id_jobentry, "batch_logging_connection_id"));
	        batchLoggingConnectionName = rep.getJobEntryAttributeString(id_jobentry, "batch_logging_connection_name");
	        batchLoggingSchema     = rep.getJobEntryAttributeString(id_jobentry, "batch_logging_schema");
	        batchLoggingTable      = rep.getJobEntryAttributeString(id_jobentry, "batch_logging_table");

	        periodicity = rep.getJobEntryAttributeString(id_jobentry, "periodicity");
	        operationType = findOperationTypeByCode( rep.getJobEntryAttributeString(id_jobentry, "operation_type") );
	        batchIdVariableName = rep.getJobEntryAttributeString(id_jobentry, "batch_id_variable");
	    }
	...
	public void saveRep(Repository rep, long id_job) throws KettleException
	{
		try
		{
			...
			rep.saveJobEntryAttribute(id_job, getID(), "batch_id_connection_id",  batchIdConnection==null ? -1L : batchIdConnection.getID());
			rep.saveJobEntryAttribute(id_job, getID(), "batch_id_connection_name",   batchIdConnectionName);
			rep.saveJobEntryAttribute(id_job, getID(), "batch_id_schema",   batchIdSchema);
			rep.saveJobEntryAttribute(id_job, getID(), "batch_id_table",    batchIdTable);
			
			rep.saveJobEntryAttribute(id_job, getID(), "batch_logging_connection_id",  batchLoggingConnection==null ? -1L : batchLoggingConnection.getID());
			rep.saveJobEntryAttribute(id_job, getID(), "batch_logging_connection_name",   batchLoggingConnectionName);
			rep.saveJobEntryAttribute(id_job, getID(), "batch_logging_schema",   batchLoggingSchema);
			rep.saveJobEntryAttribute(id_job, getID(), "batch_logging_table",    batchLoggingTable);
			
			rep.saveJobEntryAttribute(id_job, getID(), "periodicity",    periodicity);
			rep.saveJobEntryAttribute(id_job, getID(), "operation_type",    operationType == null ? null : operationType.getCode());
			rep.saveJobEntryAttribute(id_job, getID(), "batch_id_variable",    periodicity);
		}
