...
public class SeasonDialog extends BaseStepDialog implements StepDialogInterface
{
	...
	public String open()
	{
		...
		shell.setText(Messages.getString("SeasonDialog.Shell.Title")); //$NON-NLS-1$

		// Stepname line
		wlStepname=new Label(shell, SWT.RIGHT);
		wlStepname.setText(Messages.getString("SeasonDialog.Stepname.Label")); //$NON-NLS-1$
		...
		wlIgnoreErrors.setText(Messages.getString("SeasonDialog.IgnoreErrors.Label")); //$NON-NLS-1$
	...
	private void addFields()
	{
		columns = new ColumnInfo[] { 
				new ColumnInfo(Messages.getString("SeasonDialog.Result.Column"), ColumnInfo.COLUMN_TYPE_TEXT, false),
				new ColumnInfo(Messages.getString("SeasonDialog.Century.Column"), ColumnInfo.COLUMN_TYPE_CCOMBO, new String[] {}, false),
				new ColumnInfo(Messages.getString("SeasonDialog.Year.Column"), ColumnInfo.COLUMN_TYPE_CCOMBO, new String[] {}, false),
				new ColumnInfo(Messages.getString("SeasonDialog.SeasonNumber.Column"), ColumnInfo.COLUMN_TYPE_CCOMBO, new String[] {}, false),
		};
		
        // Table with fields
		wlFields=new Label(shell, SWT.NONE);
		wlFields.setText(Messages.getString("SeasonDialog.Fields.Label"));
		...
		Runnable fieldLoader = new Runnable() {
			public void run() {
				try {
					...
					String msg = Messages.getString("SeasonDialog.DoMapping.UnableToFindInput");
