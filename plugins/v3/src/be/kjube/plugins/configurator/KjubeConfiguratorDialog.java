...
public class KjubeConfiguratorDialog extends JobEntryDialog implements JobEntryDialogInterface
{
    ...
    public KjubeConfiguratorDialog(Shell parent, JobEntryInterface jobEntry, Repository rep, JobMeta jobMeta)
    {
        ...
        if (this.jobEntry.getName() == null)
            this.jobEntry.setName(Messages.getString("KjubeConfiguratorDialog.Name.Default"));
    }
    ...
    public JobEntryInterface open()
    {
        ...
        shell.setText(Messages.getString("KjubeConfiguratorDialog.Title"));

        int margin = Const.MARGIN;

        // Job entry name line
        wName = new LabelText(shell, Messages.getString("KjubeConfiguratorDialog.Name.Label"), Messages
            .getString("KjubeConfiguratorDialog.Name.Tooltip"));
	    ...
	    gParametersGroup.setText(Messages.getString("KjubeConfiguratorDialog.Parameters.Group.Label"));
        ...
        // ServerName line
        wCustomerParameterName = new LabelTextVar(jobMeta, gParametersGroup, Messages.getString("KjubeConfiguratorDialog.CustomerParameter.Label"), Messages.getString("KjubeConfiguratorDialog.CustomerParameter.Tooltip", Kjube.DEFAULT_CUSTOMER_PARAMETER));
        ...
        // UserName line
        wApplicationParameterName = new LabelTextVar(jobMeta, gParametersGroup, Messages.getString("KjubeConfiguratorDialog.ApplicationParameter.Label"), Messages.getString("KjubeConfiguratorDialog.ApplicationParameter.Tooltip", Kjube.DEFAULT_APPLICATION_PARAMETER));
        ...
        // Password line
        wLifecycleParameterName = new LabelTextVar(jobMeta, gParametersGroup, Messages.getString("KjubeConfiguratorDialog.LifecycleParameter.Label"), Messages.getString("KjubeConfiguratorDialog.LifecycleParameter.Tooltip", Kjube.DEFAULT_LIFECYCLE_PARAMETER));
        ...
        // Proxy host line
        wConfigFilePath = new LabelTextVar(jobMeta, gParametersGroup, Messages.getString("KjubeConfiguratorDialog.ConfigFilePath.Label"), Messages.getString("KjubeConfiguratorDialog.ConfigFilePath.Tooltip", Kjube.DEFAULT_CONFIG_FILE_PATH));
        ...
        wAdd.setText(Messages.getString("KjubeConfiguratorDialog.Button.AddVerifyParameters.Label"));
        wAdd.setToolTipText(Messages.getString("KjubeConfiguratorDialog.Button.AddVerifyParameters.Tooltip"));
    ...
    public void addVerifyParameters() {
    	...
    	if (Const.indexOfString(parameter, jobMeta.listParameters())<0) {
			...
			//
    		try {
    			jobMeta.addParameterDefinition(parameter, "", Messages.getString("KjubeConfiguratorDialog.CustomerParameter.ParamDesc"));
    	...
    	if (Const.indexOfString(parameter, jobMeta.listParameters())<0) {
			...
			//
			try {
				jobMeta.addParameterDefinition(parameter, "", Messages.getString("KjubeConfiguratorDialog.ApplicationParameter.ParamDesc"));
				feedback.append("Parameter '"+parameter+" was added to the parent job").append(Const.CR);
			} catch(DuplicateParamException ex) {
				// IGNORE
			}
    	...
    	if (Const.indexOfString(parameter, jobMeta.listParameters())<0) {
    		...
    		//
    		try {
    			jobMeta.addParameterDefinition(parameter, "", Messages.getString("KjubeConfiguratorDialog.LifecycleParameter.ParamDesc"));
    			feedback.append("Parameter '"+parameter+" was added to the parent job").append(Const.CR);
    		} catch(DuplicateParamException ex) {
    			// IGNORE
    		}
