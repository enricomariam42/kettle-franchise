...
public class DataGridDialog extends BaseStepDialog implements StepDialogInterface
{
	...
	public String open()
	{
		...
		shell.setText(Messages.getString("DataGridDialog.DialogTitle"));
		...
		wMetaTab.setText(Messages.getString("DataGridDialog.Meta.Label"));
		...
		ColumnInfo[] colinf=new ColumnInfo[] {
			new ColumnInfo(Messages.getString("DataGridDialog.Name.Column"),       ColumnInfo.COLUMN_TYPE_TEXT,   false),
			new ColumnInfo(Messages.getString("DataGridDialog.Type.Column"),       ColumnInfo.COLUMN_TYPE_CCOMBO, ValueMeta.getTypes() ),
			new ColumnInfo(Messages.getString("DataGridDialog.Format.Column"),     ColumnInfo.COLUMN_TYPE_CCOMBO,Const.getConversionFormats()),
			new ColumnInfo(Messages.getString("DataGridDialog.Length.Column"),     ColumnInfo.COLUMN_TYPE_TEXT,   false),
			new ColumnInfo(Messages.getString("DataGridDialog.Precision.Column"),  ColumnInfo.COLUMN_TYPE_TEXT,   false), 
			new ColumnInfo(Messages.getString("DataGridDialog.Currency.Column"),   ColumnInfo.COLUMN_TYPE_TEXT,   false),
			new ColumnInfo(Messages.getString("DataGridDialog.Decimal.Column"),    ColumnInfo.COLUMN_TYPE_TEXT,   false),
			new ColumnInfo(Messages.getString("DataGridDialog.Group.Column"),      ColumnInfo.COLUMN_TYPE_TEXT,   false),
		};
		...
		wDataTab.setText(Messages.getString("DataGridDialog.Data.Label"));
