...
public class DateTimeDialog extends BaseStepDialog implements StepDialogInterface
{
	...
	public String open()
	{
		...
		shell.setText(BaseMessages.getString(PKG, "DateTimeDialog.Shell.Title")); //$NON-NLS-1$

		// Stepname line
		wlStepname=new Label(shell, SWT.RIGHT);
		wlStepname.setText(BaseMessages.getString(PKG, "DateTimeDialog.Stepname.Label")); //$NON-NLS-1$
		...
		wlIgnoreErrors.setText(BaseMessages.getString(PKG, "DateTimeDialog.IgnoreErrors.Label")); //$NON-NLS-1$
	...
	private void addFields()
	{
		columns = new ColumnInfo[] { 
				new ColumnInfo(BaseMessages.getString(PKG, "DateTimeDialog.Result.Column"), ColumnInfo.COLUMN_TYPE_TEXT, false),
				new ColumnInfo(BaseMessages.getString(PKG, "DateTimeDialog.Century.Column"), ColumnInfo.COLUMN_TYPE_CCOMBO, new String[] {}, false),
				new ColumnInfo(BaseMessages.getString(PKG, "DateTimeDialog.Year.Column"), ColumnInfo.COLUMN_TYPE_CCOMBO, new String[] {}, false),
				new ColumnInfo(BaseMessages.getString(PKG, "DateTimeDialog.Month.Column"), ColumnInfo.COLUMN_TYPE_CCOMBO, new String[] {}, false),
				new ColumnInfo(BaseMessages.getString(PKG, "DateTimeDialog.Day.Column"), ColumnInfo.COLUMN_TYPE_CCOMBO, new String[] {}, false),
				new ColumnInfo(BaseMessages.getString(PKG, "DateTimeDialog.Hours.Column"), ColumnInfo.COLUMN_TYPE_CCOMBO, new String[] {}, false),
				new ColumnInfo(BaseMessages.getString(PKG, "DateTimeDialog.Minutes.Column"), ColumnInfo.COLUMN_TYPE_CCOMBO, new String[] {}, false),
				new ColumnInfo(BaseMessages.getString(PKG, "DateTimeDialog.Seconds.Column"), ColumnInfo.COLUMN_TYPE_CCOMBO, new String[] {}, false), };
		
        // Table with fields
		wlFields=new Label(shell, SWT.NONE);
		wlFields.setText(BaseMessages.getString(PKG, "DateTimeDialog.Fields.Label"));
		...
		Runnable fieldLoader = new Runnable() {
			public void run() {
				try {
					...
					String msg = BaseMessages.getString(PKG, "DateTimeDialog.DoMapping.UnableToFindInput");
