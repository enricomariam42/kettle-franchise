...
@Step(
		...
		description = "kJube.Plugins.TrimStrings.Description",
		name = "kJube.Plugins.TrimStrings.Name",
...
public class TrimMeta extends BaseStepMeta implements StepMetaInterface
{
	...
	public enum TrimType {
		...
		NONE(BaseMessages.getString(PKG, "TrimMeta.TrimType.None")), // $NON-NLS-1$ 
		LEFT(BaseMessages.getString(PKG, "TrimMeta.TrimType.Left")), // $NON-NLS-1$ 
		RIGHT(BaseMessages.getString(PKG, "TrimMeta.TrimType.Right")), // $NON-NLS-1$ 
		BOTH(BaseMessages.getString(PKG, "TrimMeta.TrimType.Both")); // $NON-NLS-1$
