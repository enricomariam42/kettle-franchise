...
@Step(
		...
		tooltip="kJube.Plugins.TableCompare.Description",
		description="kJube.Plugins.TableCompare.Name",
...
public class TableCompareMeta extends BaseStepMeta implements StepMetaInterface
{
    ...
    public void getFields(RowMetaInterface inputRowMeta, String origin, RowMetaInterface[] info, StepMeta nextStep, VariableSpace space) throws KettleStepException {
    	...
    	if (Const.isEmpty(nrErrorsField)) throw new KettleStepException(Messages.getString("TableCompareMeta.Exception.NrErrorsFieldIsNotSpecified"));
    	if (Const.isEmpty(nrRecordsReferenceField)) throw new KettleStepException(Messages.getString("TableCompareMeta.Exception.NrRecordsReferenceFieldNotSpecified"));
    	if (Const.isEmpty(nrRecordsCompareField)) throw new KettleStepException(Messages.getString("TableCompareMeta.Exception.NrRecordsCompareFieldNotSpecified"));
    	if (Const.isEmpty(nrErrorsLeftJoinField)) throw new KettleStepException(Messages.getString("TableCompareMeta.Exception.NrErrorsLeftJoinFieldNotSpecified"));
    	if (Const.isEmpty(nrErrorsInnerJoinField)) throw new KettleStepException(Messages.getString("TableCompareMeta.Exception.NrErrorsInnerJoinFieldNotSpecified"));
    	if (Const.isEmpty(nrErrorsRightJoinField)) throw new KettleStepException(Messages.getString("TableCompareMeta.Exception.NrErrorsRightJoinFieldNotSpecified"));
   ...
   public String getXML() {
    ...
    public void readRep(Repository rep, long id_step, List<DatabaseMeta> databases, Map<String, Counter> counters) throws KettleException {
	        try
	        {
		        referenceConnection = DatabaseMeta.findDatabase(databases, rep.getStepAttributeInteger(id_step, "reference_connection_id"));
	        	...
	        	compareConnection = DatabaseMeta.findDatabase(databases, rep.getStepAttributeInteger(id_step, "compare_connection_id"));
	    ...
	    public void saveRep(Repository rep, long id_transformation, long id_step) throws KettleException
	    {
	        try
	        {
				rep.saveStepAttribute(id_transformation, getID(), "reference_connection_id",  referenceConnection==null ? -1L : referenceConnection.getID());
	        	...
	        	rep.saveStepAttribute(id_transformation, getID(), "compare_connection_id",  compareConnection==null ? -1L : compareConnection.getID());
