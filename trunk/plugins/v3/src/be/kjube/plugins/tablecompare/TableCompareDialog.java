...
public class TableCompareDialog extends BaseStepDialog implements StepDialogInterface
{
	...
	public String open()
	{
		...
		shell.setText(Messages.getString("TableCompareDialog.Shell.Title")); //$NON-NLS-1$

		// Stepname line
		wlStepname=new Label(shell, SWT.RIGHT);
		wlStepname.setText(Messages.getString("TableCompareDialog.Stepname.Label")); //$NON-NLS-1$
		...
		//
		wReferenceDB=new LabelComboVar(transMeta, shell, Messages.getString("TableCompareDialog.ReferenceDB.Label"), Messages.getString("TableCompareDialog.ReferenceDB.Tooltip"));
		...
		wReferenceSchema=new LabelComboVar(transMeta, shell, Messages.getString("TableCompareDialog.ReferenceSchemaField.Label"), Messages.getString("TableCompareDialog.ReferenceSchemaField.Tooltip"));
		...
		wReferenceTable=new LabelComboVar(transMeta, shell, Messages.getString("TableCompareDialog.ReferenceTableField.Label"), Messages.getString("TableCompareDialog.ReferenceTableField.Tooltip"));
		...
		wCompareDB=new LabelComboVar(transMeta, shell, Messages.getString("TableCompareDialog.CompareDB.Label"), Messages.getString("TableCompareDialog.CompareDB.Tooltip"));
		...
		wCompareSchema=new LabelComboVar(transMeta, shell, Messages.getString("TableCompareDialog.CompareSchemaField.Label"), Messages.getString("TableCompareDialog.CompareSchemaField.Tooltip"));
		...
		wCompareTable=new LabelComboVar(transMeta, shell, Messages.getString("TableCompareDialog.CompareTableField.Label"), Messages.getString("TableCompareDialog.CompareTableField.Tooltip"));
		...
		wKeyFields=new LabelComboVar(transMeta, shell, Messages.getString("TableCompareDialog.KeyFieldsField.Label"), Messages.getString("TableCompareDialog.KeyFieldsField.Tooltip"));
		...
		wExcludeFields=new LabelComboVar(transMeta, shell, Messages.getString("TableCompareDialog.ExcludeFieldsField.Label"), Messages.getString("TableCompareDialog.ExcludeFieldsField.Tooltip"));
		...
		//
		wNrErrors=new LabelTextVar(transMeta, shell, Messages.getString("TableCompareDialog.NrErrorsField.Label"), Messages.getString("TableCompareDialog.NrErrorsField.Tooltip"));
		...
		//
		wNrRecordsReference=new LabelTextVar(transMeta, shell, Messages.getString("TableCompareDialog.NrRecordsReferenceField.Label"), Messages.getString("TableCompareDialog.NrRecordsReferenceField.Tooltip"));
		...
		//
		wNrRecordsCompare=new LabelTextVar(transMeta, shell, Messages.getString("TableCompareDialog.NrRecordsCompareField.Label"), Messages.getString("TableCompareDialog.NrRecordsCompareField.Tooltip"));
		...
		//
		wNrErrorsLeftJoin=new LabelTextVar(transMeta, shell, Messages.getString("TableCompareDialog.NrErrorsLeftJoinField.Label"), Messages.getString("TableCompareDialog.NrErrorsLeftJoinField.Tooltip"));
		...
		//
		wNrErrorsInnerJoin=new LabelTextVar(transMeta, shell, Messages.getString("TableCompareDialog.NrErrorsInnerJoinField.Label"), Messages.getString("TableCompareDialog.NrErrorsInnerJoinField.Tooltip"));
		...
		//
		wNrErrorsRightJoin=new LabelTextVar(transMeta, shell, Messages.getString("TableCompareDialog.NrErrorsRightJoinField.Label"), Messages.getString("TableCompareDialog.NrErrorsRightJoinField.Tooltip"));
		...
		wKeyDesc=new LabelComboVar(transMeta, shell, Messages.getString("TableCompareDialog.KeyDescField.Label"), Messages.getString("TableCompareDialog.KeyDescField.Tooltip"));
		...
		wReferenceValue=new LabelComboVar(transMeta, shell, Messages.getString("TableCompareDialog.ReferenceValueField.Label"), Messages.getString("TableCompareDialog.ReferenceValueField.Tooltip"));
		...
		wCompareValue=new LabelComboVar(transMeta, shell, Messages.getString("TableCompareDialog.CompareValueField.Label"), Messages.getString("TableCompareDialog.CompareValueField.Tooltip"));
		...
		Runnable fieldLoader = new Runnable() {
			public void run() {
				...
				try {
					...
					String msg = Messages.getString("TableCompareDialog.DoMapping.UnableToFindInput");
