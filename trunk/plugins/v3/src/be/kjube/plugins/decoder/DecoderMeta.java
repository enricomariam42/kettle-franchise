...
@Step(
		...
		tooltip="kJube.Plugins.Decoder.Description",
		description="kJube.Plugins.Decoder.Name",
  ...
  private String maskFieldTrimField;
	...
	public void loadXML(Node stepnode, List<DatabaseMeta> databases, Map<String, Counter> counters) throws KettleXMLException
	{
	   ...
	   public void readRep(Repository rep, long id_step, List<DatabaseMeta> databases, Map<String, Counter> counters) throws KettleException {
	        try
	        {
		        connection = DatabaseMeta.findDatabase(databases, rep.getStepAttributeInteger(id_step, CODE_CONNECTION_ID));
	    ...
	    public void saveRep(Repository rep, long id_transformation, long id_step) throws KettleException
	    {
	        try
	        {
				rep.saveStepAttribute(id_transformation, getID(), CODE_CONNECTION_ID,  connection==null ? -1L : connection.getID());
				rep.saveStepAttribute(id_transformation, getID(), CODE_CONNECTION_NAME,   connectionName);
				rep.saveStepAttribute(id_transformation, getID(), CODE_SCHEMA,   schema);
	...
	public String[] getInfoSteps() {
		return new String[] { maskSourceStep, };
	}
