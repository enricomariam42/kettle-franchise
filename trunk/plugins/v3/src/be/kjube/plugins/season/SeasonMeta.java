...
@Step(
		...
		tooltip = "kJube.Plugins.Season.Description", 
		description = "kJube.Plugins.Season.Name", 
...
public class SeasonMeta extends BaseStepMeta implements StepMetaInterface {
	public enum ColumnType {
		...
		CENTURIES(Messages.getString("Season.ColumnType.Centuries")), // $NON-NLS-1$
		YEARS(Messages.getString("Season.ColumnType.Years")), // $NON-NLS-1$
		SEASON_NUMBER(Messages.getString("Season.ColumnType.SeasonNumber")), // $NON-NLS-1$
		;
