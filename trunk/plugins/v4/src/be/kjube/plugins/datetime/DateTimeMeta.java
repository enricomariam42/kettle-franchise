...
@Step(
		...
		description = "kJube.Plugins.DateTime.Description", 
		name = "kJube.Plugins.DateTime.Name", 
...
public class DateTimeMeta extends BaseStepMeta implements StepMetaInterface {
	...
	public enum ColumnType {
		...
		CENTURIES(BaseMessages.getString(PKG, "DateTime.ColumnType.Centuries")), // $NON-NLS-1$
		YEARS(BaseMessages.getString(PKG, "DateTime.ColumnType.Years")), // $NON-NLS-1$
		MONTHS(BaseMessages.getString(PKG, "DateTime.ColumnType.Months")), // $NON-NLS-1$
		DAYS(BaseMessages.getString(PKG, "DateTime.ColumnType.Days")), // $NON-NLS-1$
		HOURS(BaseMessages.getString(PKG, "DateTime.ColumnType.Hours")), // $NON-NLS-1$
		MINUTES(BaseMessages.getString(PKG, "DateTime.ColumnType.Minutes")), // $NON-NLS-1$
		SECONDS(BaseMessages.getString(PKG, "DateTime.ColumnType.Seconds")), // $NON-NLS-1$
		;
