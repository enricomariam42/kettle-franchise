...
public class RejectsDialog extends BaseStepDialog implements StepDialogInterface
{
	...
	public String open()
	{
		...
		shell.setText(BaseMessages.getString(PKG, "RejectsDialog.Shell.Title")); //$NON-NLS-1$

		// Stepname line
		wlStepname=new Label(shell, SWT.RIGHT);
		wlStepname.setText(BaseMessages.getString(PKG, "RejectsDialog.Stepname.Label")); //$NON-NLS-1$
        ...
        wRejectsConnection = new LabelComboVar(transMeta, shell, BaseMessages.getString(PKG, "RejectsDialog.RejectsConnection.Label"), BaseMessages.getString(PKG, "RejectsDialog.RejectsConnection.Tooltip", Kjube.DEFAULT_BATCH_ID_CONNECTION));
        ...
        // the batch id schema
	    //
        wRejectsSchema = new LabelTextVar(transMeta, shell, BaseMessages.getString(PKG, "RejectsDialog.RejectsSchema.Label"), BaseMessages.getString(PKG, "RejectsDialog.RejectsSchema.Tooltip", Kjube.DEFAULT_BATCH_ID_SCHEMA));
        ...
        // the batch id table        
        //
        wRejectsTable = new LabelTextVar(transMeta, shell, BaseMessages.getString(PKG, "RejectsDialog.RejectsTable.Label"), BaseMessages.getString(PKG, "RejectsDialog.RejectsTable.Tooltip", Kjube.DEFAULT_BATCH_ID_TABLE));
        ...
        wErrorCountField = new LabelComboVar(transMeta, shell, BaseMessages.getString(PKG, "RejectsDialog.ErrorCountField.Label"), BaseMessages.getString(PKG, "RejectsDialog.ErrorCountField.Tooltip", Kjube.DEFAULT_BATCH_ID_CONNECTION));
        ...
        wErrorDescriptionsField = new LabelComboVar(transMeta, shell, BaseMessages.getString(PKG, "RejectsDialog.ErrorDescriptionsField.Label"), BaseMessages.getString(PKG, "RejectsDialog.ErrorDescriptionsField.Tooltip", Kjube.DEFAULT_BATCH_ID_CONNECTION));
        ...
        wErrorFieldsField = new LabelComboVar(transMeta, shell, BaseMessages.getString(PKG, "RejectsDialog.ErrorFieldsField.Label"), BaseMessages.getString(PKG, "RejectsDialog.ErrorFieldsField.Tooltip", Kjube.DEFAULT_BATCH_ID_CONNECTION));
        ...
        wErrorCodesField = new LabelComboVar(transMeta, shell, BaseMessages.getString(PKG, "RejectsDialog.ErrorCodesField.Label"), BaseMessages.getString(PKG, "RejectsDialog.ErrorCodesField.Tooltip", Kjube.DEFAULT_BATCH_ID_CONNECTION));
...
;
	...
	private void addFields()
	{
		keyColumns=new ColumnInfo[] {
			new ColumnInfo(BaseMessages.getString(PKG, "RejectsDialog.KeyField.Column"),  ColumnInfo.COLUMN_TYPE_CCOMBO, new String[] {}, false),
		};
		
        // Table with fields
		wlFields=new Label(shell, SWT.NONE);
		wlFields.setText(BaseMessages.getString(PKG, "RejectsDialog.Fields.Label"));
	...
	private void sql()
	{
		try
		{
			...
			if (!sql.hasError())
			{
				...
				else
				{
					...
					mb.setMessage(BaseMessages.getString(PKG, "RejectsDialog.NoSQL.DialogMessage"));
					mb.setText(BaseMessages.getString(PKG, "RejectsDialog.NoSQL.DialogTitle"));
					mb.open(); 
				}
			}
			else
		...
		{
			new ErrorDialog(shell, BaseMessages.getString(PKG, "RejectsDialog.BuildSQLError.DialogTitle"), BaseMessages.getString(PKG, "RejectsDialog.BuildSQLError.DialogMessage"), ke);
		}
	}
