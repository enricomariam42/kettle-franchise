...
public class OdsGenerator {
	...
	public void generate() throws Exception {
		...
		LogChannelInterface log = new LogChannel("ODS Generator");
		
		log.logDetailed("Generating transformation ["+filename+"] to copy data from table ["+sourceTable+"] to ["+targetTable+"]");
	...
	private RowMetaInterface getTargetFields(String targetTable) throws KettleException {
		Database db = new Database(null, targetDb); 
		try {
			db.connect();
