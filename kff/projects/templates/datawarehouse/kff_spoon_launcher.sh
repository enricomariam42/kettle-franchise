...
PROJECT_KETTLE_VERSION_UAI=/kff/software/pdi/3.2.5
PROJECT_KETTLE_VERSION_TST=/kff/software/pdi/4.0.0
PROJECT_KETTLE_VERSION_DEV=/kff/software/pdi/4.0.1
...
while true; do
    ...
    case $putd in
        [Pp] )  echo "Launching PDI $PROJECT_KETTLE_VERSION_PRD for $CUSTOMER_NAME - $PROJECT_NAME (PRD)" 
                ...
                cp -T -f /$PROJECT_DIR/config/.spoonrc $HOME/.kettle/.spoonrc ;
